...
public class ParamsUtil {
    ...
    public void refresh() {
        ...
        // file = null;
        // }
        // log.info("【unionpay_params.properties path is】:" + path +
        // fileName);
        // Properties prop = new Properties();
        // InputStream stream = null;
        // stream = new BufferedInputStream(new FileInputStream(new
        // File(path + fileName)));
        // prop.load(stream);
        ...
        RESOURCE = ResourceBundle.getBundle("unionpay_params");
        merchantId = RESOURCE.getString("merchantId");
        certId = RESOURCE.getString("certId");
        certPath = RESOURCE.getString("certPath");
        certPasswd = RESOURCE.getString("certPasswd");
        address = RESOURCE.getString("address");
        version = RESOURCE.getString("version");
        encoding = RESOURCE.getString("encoding");
        signMethod = RESOURCE.getString("signMethod");
        backUrl = RESOURCE.getString("backUrl");
        dkType = RESOURCE.getString("dkType");
        atType = RESOURCE.getString("atType");
